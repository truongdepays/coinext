...
export interface MultisigAsMulti extends Omit<MultiSigApproveAsMulti, 'callHash'> {
    /**
 ...
 */
export declare function asMulti(args: MultisigAsMulti, info: BaseTxInfo, options: OptionsWithMeta): UnsignedTransaction;

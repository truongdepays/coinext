...
export interface MultisigCancelAsMulti extends Omit<MultiSigApproveAsMulti, 'maxWeight' | 'maybeTimepoint'> {
    /**
 ...
 */
export declare function cancelAsMulti(args: MultisigCancelAsMulti, info: BaseTxInfo, options: OptionsWithMeta): UnsignedTransaction;

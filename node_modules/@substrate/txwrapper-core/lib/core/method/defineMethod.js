...
function defineMethod(info, options) {
    const { metadataRpc, registry, asCallsOnlyArg, signedExtensions, userExtensions, } = options;
    const generatedMetadata = (0, metadata_1.createMetadata)(registry, metadataRpc, asCallsOnlyArg);
     ...
     */
    const eraPeriod = info.eraPeriod === 0 || info.eraPeriod
        ? info.eraPeriod
        : DEFAULTS.eraPeriod;
    return {

...
export declare function eqPublicKey(a: bip32.BIP32Interface, b: bip32.BIP32Interface): boolean;
/**
...
export declare class WalletKeys {
    readonly triple: Triple<bip32.BIP32Interface>;
    readonly publicKeys: Triple<Buffer>;
    /**
     * @param triple - bip32 key triple
     */
    constructor(triple: Triple<bip32.BIP32Interface>);
...
export declare class RootWalletKeys extends WalletKeys {
     ...
     */
    constructor(triple: Triple<bip32.BIP32Interface>, derivationPrefixes?: Triple<string>);
    /**
     * @param key
     * @param chain
     * @param index

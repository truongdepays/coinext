 ...
 */
export declare function getAccountHash(keys: DefaultKeys): Uint8Array;
/**
 ...
 */
export declare function isValidEd25519Address(address: string): boolean;
/**
 * validate secp256k1 address
 * @param {string} address hex string composed of a prefix and an secp256k1 public key
 * @returns {boolean} true if address is valid
 */
export declare function isValidSecp256k1Address(address: string): boolean;
/**
 * validate address.
 *
 ...
 */
export declare function normalizeAddress({ address, transferId }: AddressDetails): string;
/**
 ...
 */
export declare function isValidTransferAmount(amount: string): boolean;
/**
 ...
 * @returns {boolean} - the validation result
 */
export declare function isValidDelegateAmount(amount: string): boolean;
/**
 ...
 * @returns {boolean} - the validation result
 */
export declare function isValidTransferId(id: number): boolean;
/**
 ...
 */
export declare function getTransferDestinationAddress(transferTx: DeployUtil.ExecutableDeployItem): string;
/**
 ...
 */
export declare function getTransferAmount(transferTx: DeployUtil.ExecutableDeployItem): string;
/**
 ...
 */
export declare function getTransferId(transferTx: DeployUtil.ExecutableDeployItem): number | undefined;
/**
 ...
 */
export declare function getDelegatorAddress(delegateTx: DeployUtil.ExecutableDeployItem): string;
/**
 ...
 * @returns {string} the hex destination address of the delegate / undelegate
 */
export declare function getValidatorAddress(delegateTx: DeployUtil.ExecutableDeployItem): string;
/**
 ...
 */
export declare function getDelegateAmount(delegateTx: DeployUtil.ExecutableDeployItem): string;
/**
 ...
 */
export declare function getDeployType(session: DeployUtil.ExecutableDeployItem): TransactionType | undefined;
/**
 ...
 */
export declare function signMessage(keyPair: KeyPair, data: string): SignResponse;
/**
 ...
 */
export declare function verifySignature(signature: string, data: Uint8Array | string, publicKey: string): void;
/**
 ...
 */
export declare function isValidMessageSignature(signature: string, data: Uint8Array | string, publicKey: string): boolean;
/**
 ...
 * @returns {boolean} true if the signature is valid on data
 */
export declare function isValidTransactionSignature(signature: string, data: Uint8Array | string, publicKey: string): boolean;
/**
 * Remove signature algo prefix added to hex values by the casper sdk
 * @param {string} hexValue - hex value to remove prefix from
 */
export declare function removeAlgoPrefixFromHexValue(hexValue: string): string;
/**

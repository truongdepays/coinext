...
class TokenInfo {
  ...
  static _fromProtobuf(info) {
    ...
    return new TokenInfo({
      ...
      kycKey: info.kycKey != null ? (0, _protobuf.keyFromProtobuf)(info.kycKey) : null,
      freezeKey: info.freezeKey != null ? (0, _protobuf.keyFromProtobuf)(info.freezeKey) : null,
      pauseKey: info.pauseKey != null ? (0, _protobuf.keyFromProtobuf)(info.pauseKey) : null,
      wipeKey: info.wipeKey != null ? (0, _protobuf.keyFromProtobuf)(info.wipeKey) : null,
      supplyKey: info.supplyKey != null ? (0, _protobuf.keyFromProtobuf)(info.supplyKey) : null,
      feeScheduleKey: info.feeScheduleKey != null ? (0, _protobuf.keyFromProtobuf)(info.feeScheduleKey) : null,
  ...
  _toProtobuf() {
    return {
      ...
      pauseKey: this.pauseKey != null ? (0, _protobuf.keyToProtobuf)(this.pauseKey) : null,

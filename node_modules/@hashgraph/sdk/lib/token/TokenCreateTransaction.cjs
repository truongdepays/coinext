...
class TokenCreateTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    return _Transaction.default._fromProtobufTransactions(new TokenCreateTransaction({
      ...
      pauseKey: create.pauseKey != null ? (0, _protobuf.keyFromProtobuf)(create.pauseKey) : undefined,
  ...
  _makeTransactionData() {
    return {
      ...
      pauseKey: this._pauseKey != null ? (0, _protobuf.keyToProtobuf)(this._pauseKey) : null,
